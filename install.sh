...
nmcli con add type ethernet ifname eth0 ipv4.addresses 192.168.19.90/24 ipv4.gateway 192.168.19.1 ipv4.dns 8.8.8.8,8.8.4.4 ipv4.method manual con-name eth0
